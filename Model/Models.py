...
class MainWindow(QMainWindow):
    def __init__(self, dado=None, io=None):
        ...
        self.ui.btDesligar.clicked.connect(self.desligar_sistema)
    ...
    def iniciar(self):
        view = ViewProgamas(dado=self.dado)
    ...
    def shutdown_pi(self):
        print("Desligando o Raspberry Pi com segurança em 5 segundos...")
        time.sleep(5)  # Espera 10 segundos antes de iniciar o processo de desligamento
